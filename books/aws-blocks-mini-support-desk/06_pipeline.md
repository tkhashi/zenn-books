---
title: "Blocks Pipeline を定義して synth する"
free: true
---
...
エラーなく CloudFormation テンプレートが出力されれば、定義は妥当です。**ここまでは AWS アカウント不要**で、課金も発生しません。本編としてはここまでで十分です。
...
- `cdk synth` でローカル合成して定義の妥当性を確認した
